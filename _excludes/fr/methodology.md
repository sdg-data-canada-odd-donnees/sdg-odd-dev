...
Le Cadre mondial d'indicateurs (CMI) est un outil complet qui permet aux pays de mesurer et de rendre compte de leurs progrès sur les 17 objectifs de développement durable (ODD) d'une manière normalisée. Ce cadre met l'accent sur les priorités mondiales en matière de développement durable et fournit un ensemble unifié d'indicateurs applicables dans différents contextes. Chacun des 17 ODD est associé à des cibles spécifiques, ce qui permet d'évaluer quantitativement les progrès accomplis.

Quant au Cadre d'indicateurs canadien (CIC), bien qu'il s'aligne sur les ODD, il est adapté aux priorités canadiennes et comprend 31 ambitions et 76 indicateurs qui sont propres au Canada. Cependant, contrairement au Cadre d’indicateur mondial où chaque indicateur a une cible, moins de la moitié des indicateurs du CIC ont actuellement une cible établie, qu’elle soit quantitative (p. ex. la cible 11.5 *D’ici 2030, 22% des navetteurs adoptent le transport en commun ou actif*) ou aspirationnelle (p. ex. la cible 5.2 *Représentation accrue des femmes dans les rôles de leadership*).   
